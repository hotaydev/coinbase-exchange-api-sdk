import {
  IProductBook,
  IProductBookQueryParams,
  IProductCandles,
  IProductCandlesQueryParams,
  IProductStats,
  IProductTicker,
  IProductTrades,
  IProductVolume,
  ISingleProduct,
  ISingleProductQueryParams,
...
export default class ProductsEndpoint {
   ...
   */
  public async getAllKnownTradingPairs(
    query: ISingleProductQueryParams,
  ...
  public async getProductBook(
    productId: string,
    query: IProductBookQueryParams,
  ): Promise<IProductBook> {
    return (await this.instance.request({
  ...
  public async getProductCandles(
    productId: string,
    query: IProductCandlesQueryParams,
  ): Promise<IProductCandles[]> {
    return (await this.instance.request({
