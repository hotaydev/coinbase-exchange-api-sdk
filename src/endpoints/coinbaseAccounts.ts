import {
  ICoinbaseWallets,
  IGenerateCryptoAddressRequest,
  IGenerateCryptoAddressResponse,
} from "./models/coinbaseAccounts";
...
export default class CoinbaseAccountsEndpoint {
   ...
   */
  public async createCryptoAddress(
    accountId: string,
    body: IGenerateCryptoAddressRequest,
  ): Promise<IGenerateCryptoAddressResponse> {
    return (await this.instance.request({
